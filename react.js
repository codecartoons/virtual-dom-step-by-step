...
var ReactMount = {
  ...
  _renderNewRootComponent: function (nextElement, container, shouldReuseMarkup, context) {
    console.group("ReactMount._renderNewRootComponent()");
    ...
    console.log("Created the TopLevelWrapper: ", componentInstance);
...
if ("development" !== 'production') {
  ...
  var updatedAncestorInfo = function (oldInfo, tag, instance) {
    ...
    if (specialTags.indexOf(tag) !== -1 && tag !== 'address' && tag !== 'div' && tag !== 'p') {
      ancestorInfo.ItemTagAutoclosing = null;
    ...
    if (tag === 'li') {
      ancestorInfo.ItemTagAutoclosing = info;
    }
    if (tag === 'dd' || tag === 'dt') {
  ...
  var findInvalidAncestorForTag = function (tag, ancestorInfo) {
    switch (tag) {
      ...
      case 'li':
        return ancestorInfo.ItemTagAutoclosing;
